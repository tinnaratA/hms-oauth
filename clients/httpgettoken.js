...
var options = {
    ...
    host: '127.0.0.1',
    port: '8000',
    path: '/o/token/?grant_type=password&username=admin&password=admin@1234&client_id=7FK6YzhqE94whFFSsssZM0GkJsqUuCmGrvShCjyA&client_secret=7dFBEKlff5wn8QWWulYBh8Plvhtk5aTKDnHDrrGizgjM1MT4sxysCsnijJUyvanCSoUsi8T5FtR2LGEOC3xC6tAxwlX5aJonhT0s84PlHQeeQdSs2ndDysyCTAh1Nfse'
    }
// Start the request
      ...
      var users_http_request = http.request(userapi_options, function(res) {
       ...
       // console.log('request url:'+users_http_request.url);
        ...
        res.on("end", function(){
          ...
          console.log("users_http_request.end"+body);
        });
      //
    });
